...
import com.ppdai.pauth.client.auth.ApiKeyAuth;
...
import com.ppdai.pauth.client.auth.Authentication;
import com.ppdai.pauth.client.auth.HttpBasicAuth;
import com.ppdai.pauth.client.auth.OAuth;
...
public class ApiClient {
    ...
    private static Pattern pattern = Pattern.compile("filename=['\"]?([^'\"\\s]+)['\"]?");
    ...
    private String basePath = "https://127.0.0.1";
